jQuery(function($) {
    ...
    // Initialize bulk edit form - only if inlineEditPost exists
    ...
    $(document).on('submit', '#bulk-edit', function() {
        var $seriesSelect = $('select[name="series_bulk_edit"]');
        var $newSeriesInput = $('input[name="new_series_name"]');
        
        // If new series is selected but no name provided, prevent submission
        if ($seriesSelect.val() === '__new__' && !$newSeriesInput.val()) {
